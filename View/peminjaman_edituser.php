...
{   
    ...
    //audit trails
     date_default_timezone_set('Asia/Jakarta');
        ...
        $content        = 'User Mengedit Peminjaman'; 
        $id_karyawan = $_SESSION['id_karyawan'];
    ...
    <script>
                ...
                location="?page=peminjaman_indexuser";
            </script>
...
<div class="col-md-6 col-sm-6 col-xs-12">
    ...
    <div class="panel-body">
        <form role="form" method="POST">
                    ...
                    <div class="form-group">
                        <label>Status </label>
                        <input class="form-control" type="text" name="status" readonly="readonly" value="Dipinjam"<?php echo $data['status']; ?>">
                    </div>
