   <div class="header col-md-12" style="margin-top: 15px;">
                    <div class="col-md-7">
                            <form role="form" method="POST" action="?page=pembeli_indexPM">
                                ...
                                <table id="tabel_audit" class="table table-bordered table-hover table-striped">
                                    ...
                                    <tr>
                                            ...
                                            <td>Iphone </td>
                                             <td>20 April 2018</td>
                                            <td>
                                                 <a href="?page=pembeli_detailPM&id=<?php echo $user_data['id_pembeli'];?>">
                                                    <button class="btn btn-primary"><i class="fa fa-search"></i></button>
                                                </a>
                                                <a href="?page=pembeli_editPM&id=<?php echo $user_data['id_pembeli'];?>">
