...
{   
    ...
    date_default_timezone_set('Asia/Jakarta');
        ...
        $content        = 'Admin Mengedit Data Pembeli'; 
    ...
    <div class="panel-body">
        <form role="form" method="POST" enctype="multipart/form-data">
                   ...
                   <select class="form-control" name="id_karyawan">
                        ...
                        ?>
                            <option value="<?php echo $data_karyawan['id_karyawan']; ?>" <?php if ($data['nama_karyawan'] == $data_karyawan['id_karyawan']) echo 'selected'; ?>><?php echo $data_karyawan['nama_karyawan']; ?></option>
                        <?php } ?>
                        </select>
                    </div>
