...
--
-- Host: 127.0.0.1
-- Generation Time: 26 Apr 2018 pada 07.43
...
CREATE TABLE `pengajuan` (
  ...
  `foto_pengajuan` varchar(250) NOT NULL,
  `alasan` varchar(50) NOT NULL,
  `tgl_pengajuan` date NOT NULL,
  `status_pengajuan` enum('Pending','Diterima','Ditolak') NOT NULL,
...
INSERT INTO `pengajuan` (`id_pengajuan`, `id_karyawan`, `id_jenispengajuan`, `nama_pengajuan`, `biaya`, `foto_pengajuan`, `alasan`, `tgl_pengajuan`, `status_pengajuan`, `id_rab`) VALUES
('PJN01', 'DOT02', 'JP02', 'kebutuhan', 200000, '', 'meeting', '2018-01-31', '', 'RAB01'),
('PJN02', 'DOT03', 'JP02', 'Meeting', 100000, '', 'untuk review ', '2018-01-25', '', 'RAB01'),
('PJN03', 'DOT03', 'JP01', 'P3K', 200000, '', 'penting', '2018-01-03', '', 'RAB01'),
('PJN04', 'DOT02', 'JP01', 'kebutuhan', 0, '', '', '0000-00-00', '', 'RAB05'),
('PJN05', 'DOT02', 'JP01', 'assa', 2147483647, '', '', '0000-00-00', '', 'RAB05');
...
ALTER TABLE `pengajuan`
  ...
  ADD KEY `id_karyawan` (`id_karyawan`),
  ADD KEY `id_jenispengajuan` (`id_jenispengajuan`),
